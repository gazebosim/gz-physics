...
#ifndef IGNITION_PHYSICS_ODE_BUGGYDEMOCONTROLLER_HH_
#define IGNITION_PHYSICS_ODE_BUGGYDEMOCONTROLLER_HH_
...
namespace ignition
{
  namespace physics
  {
    namespace ode
    {
      ...
      {
        public: virtual ~BuggyDemoController();

        public: BuggyDemoController();

...
struct TestFeatureList : ignition::physics::FeatureList<
    ignition::physics::tpe::plugin::RetrieveWorld,
...
TEST(SDFFeatures_TEST, CheckTpeData)
{
  ...
  // check model 01
  {
    ignition::physics::tpe::lib::Entity &model =
        tpeWorld->GetChildByName("ground_plane");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        model.GetId());
    EXPECT_EQ("ground_plane", model.GetName());
    EXPECT_EQ(ignition::math::Pose3d::Zero, model.GetPose());
    EXPECT_EQ(1u, model.GetChildCount());

    ignition::physics::tpe::lib::Entity &link = model.GetChildByName("link");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link.GetId());
    ...
    ignition::physics::tpe::lib::Entity &collision =
  ...
  // check model 02
  {
    ...
    ignition::physics::tpe::lib::Entity &link = model.GetChildByName("base");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link.GetId());
    ...
    ignition::physics::tpe::lib::Entity &collision02 =
    ...
    ignition::physics::tpe::lib::Entity &link02 = model.GetChildByName("upper_link");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link02.GetId());
    ...
    ignition::physics::tpe::lib::Entity &collision03 =
    ...
    ignition::physics::tpe::lib::Entity &collision04 =
    ...
    ignition::physics::tpe::lib::Entity &collision05 =
    ...
    ignition::physics::tpe::lib::Entity &link03 = model.GetChildByName("lower_link");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link03.GetId());
    ...
    ignition::physics::tpe::lib::Entity &collision06 =
    ...
    ignition::physics::tpe::lib::Entity &collision07 =
  ...
  // check model 04
  {
    ...
    ignition::physics::tpe::lib::Entity &link02 = model.GetChildByName("bar");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link02.GetId());
  ...
  // check model 05
  {
    ...
    ignition::physics::tpe::lib::Entity &link = model.GetChildByName("link0");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link.GetId());
    ...
    ignition::physics::tpe::lib::Entity &link02 = model.GetChildByName("link1");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link02.GetId());
  ...
  // check model 06
  {
    ...
    ignition::physics::tpe::lib::Entity &link03 = model.GetChildByName("link2");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link03.GetId());
    ...
    ignition::physics::tpe::lib::Entity &link04 = model.GetChildByName("link3");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link04.GetId());
    ...
    ignition::physics::tpe::lib::Entity &link05 = model.GetChildByName("link4");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link05.GetId());
    ...
    ignition::physics::tpe::lib::Entity &link06 = model.GetChildByName("link5");
    ASSERT_NE(ignition::physics::tpe::lib::Entity::kNullEntity.GetId(),
        link06.GetId());

...
#ifndef IGNITION_PHYSICS_TPE-PLUGIN_EXPORT_HH_
#define IGNITION_PHYSICS_TPE-PLUGIN_EXPORT_HH_
...
#include "ignition/physics/tpe-plugin/detail/Export.hh"


#ifndef IGNITION_PHYSICS_TPE-PLUGIN_VISIBLE
/// For ignition-physics2-tpe-plugin developers: Apply this macro to ignition-physics2-tpe-plugin
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_PHYSICS_TPE-PLUGIN_VISIBLE \
  DETAIL_IGNITION_PHYSICS_TPE-PLUGIN_VISIBLE
#endif


#ifndef IGNITION_PHYSICS_TPE-PLUGIN_HIDDEN
/// For ignition-physics2-tpe-plugin developers: Apply this macro to ignition-physics2-tpe-plugin
...
/// not tagged with IGNITION_PHYSICS_TPE-PLUGIN_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_PHYSICS_TPE-PLUGIN_HIDDEN \
  DETAIL_IGNITION_PHYSICS_TPE-PLUGIN_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-physics2-tpe-plugin developers: Use this macro to indicate that a

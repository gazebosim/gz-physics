# - Config file for the ignition-physics2-tpe component
#
# This should only be invoked by ignition-physics2-config.cmake.
#
# To load this component into your project, use:
# find_package(ignition-physics2 COMPONENTS tpe)
#
# This creates the following targets:
#
#   Component library target                - ignition-physics2::ignition-physics2-tpe
#   Alternative target name                 - ignition-physics2::tpe
...
# this is discouraged:
#
#   ignition-physics2-tpe_LIBRARY  - Component library (actually contains ignition-physics2::tpe)
#
# We will also set ignition-physics2-tpe_FOUND to indicate that the component was found.
#
################################################################################
...
if(ignition-physics2-tpe_CONFIG_INCLUDED)
  return()
endif()
set(ignition-physics2-tpe_CONFIG_INCLUDED TRUE)

if(NOT ignition-physics2-tpe_FIND_QUIETLY)
  message(STATUS "Looking for ignition-physics2-tpe -- found version 2.1.0")
endif()
...
# dependencies.
if(ignition-physics2-tpe_FIND_REQUIRED)
...
# dependencies.
if(ignition-physics2-tpe_FIND_QUIETLY)
...
if(NOT ignition-physics2-tpe_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of ignition-physics2-tpe")
endif()
...
if(NOT TARGET ignition-physics2::ignition-physics2-tpe)
  include("${CMAKE_CURRENT_LIST_DIR}/ignition-physics2-tpe-targets.cmake")

  # Create a simplified imported target name for the tpe library.
  # You can link to this target instead of the tpe library.
  add_library(ignition-physics2::tpe INTERFACE IMPORTED)
  set_target_properties(ignition-physics2::tpe PROPERTIES
    INTERFACE_LINK_LIBRARIES "ignition-physics2::ignition-physics2-tpe")
...
if(NOT ign_requested_components)
  ...
  set_target_properties(ignition-physics2::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${ign_requested_components};ignition-physics2::ignition-physics2-tpe")
endif()

set(ignition-physics2-tpe_LIBRARY ignition-physics2::ignition-physics2-tpe)

# This macro is used by ignition-cmake to automatically configure the pkgconfig
# files for ignition projects.
ign_pkg_config_entry(ignition-physics2-tpe "ignition-physics2-tpe")

# - Config file for the ignition-physics2-tpelib component
#
# This should only be invoked by ignition-physics2-config.cmake.
#
# To load this component into your project, use:
# find_package(ignition-physics2 COMPONENTS tpelib)
#
# This creates the following targets:
#
#   Component library target                - ignition-physics2::ignition-physics2-tpelib
#   Alternative target name                 - ignition-physics2::tpelib
...
# this is discouraged:
#
#   ignition-physics2-tpelib_LIBRARY  - Component library (actually contains ignition-physics2::tpelib)
#
# We will also set ignition-physics2-tpelib_FOUND to indicate that the component was found.
#
################################################################################
...
if(ignition-physics2-tpelib_CONFIG_INCLUDED)
  return()
endif()
set(ignition-physics2-tpelib_CONFIG_INCLUDED TRUE)

if(NOT ignition-physics2-tpelib_FIND_QUIETLY)
  message(STATUS "Looking for ignition-physics2-tpelib -- found version 2.1.0")
endif()
...
# dependencies.
if(ignition-physics2-tpelib_FIND_REQUIRED)
...
# dependencies.
if(ignition-physics2-tpelib_FIND_QUIETLY)
...
if(NOT ignition-physics2-tpelib_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of ignition-physics2-tpelib")
endif()
...
if(NOT TARGET ignition-physics2::ignition-physics2-tpelib)
  include("${CMAKE_CURRENT_LIST_DIR}/ignition-physics2-tpelib-targets.cmake")

  # Create a simplified imported target name for the tpelib library.
  # You can link to this target instead of the tpelib library.
  add_library(ignition-physics2::tpelib INTERFACE IMPORTED)
  set_target_properties(ignition-physics2::tpelib PROPERTIES
    INTERFACE_LINK_LIBRARIES "ignition-physics2::ignition-physics2-tpelib")
...
if(NOT ign_requested_components)
  ...
  set_target_properties(ignition-physics2::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${ign_requested_components};ignition-physics2::ignition-physics2-tpelib")
endif()

set(ignition-physics2-tpelib_LIBRARY ignition-physics2::ignition-physics2-tpelib)

# This macro is used by ignition-cmake to automatically configure the pkgconfig
# files for ignition projects.
ign_pkg_config_entry(ignition-physics2-tpelib "ignition-physics2-tpelib")

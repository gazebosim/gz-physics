# - Config file for the ignition-physics2-tpe-plugin component
#
# This should only be invoked by ignition-physics2-config.cmake.
#
# To load this component into your project, use:
# find_package(ignition-physics2 COMPONENTS tpe-plugin)
#
# This creates the following targets:
#
#   Component library target                - ignition-physics2::ignition-physics2-tpe-plugin
#   Alternative target name                 - ignition-physics2::tpe-plugin
...
# this is discouraged:
#
#   ignition-physics2-tpe-plugin_LIBRARY  - Component library (actually contains ignition-physics2::tpe-plugin)
#
# We will also set ignition-physics2-tpe-plugin_FOUND to indicate that the component was found.
#
################################################################################
...
if(ignition-physics2-tpe-plugin_CONFIG_INCLUDED)
  return()
endif()
set(ignition-physics2-tpe-plugin_CONFIG_INCLUDED TRUE)

if(NOT ignition-physics2-tpe-plugin_FIND_QUIETLY)
  message(STATUS "Looking for ignition-physics2-tpe-plugin -- found version 2.1.0")
endif()
...
# dependencies.
if(ignition-physics2-tpe-plugin_FIND_REQUIRED)
...
# dependencies.
if(ignition-physics2-tpe-plugin_FIND_QUIETLY)
...
if(NOT ignition-physics2-tpe-plugin_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of ignition-physics2-tpe-plugin")
endif()
...
find_package(ignition-physics2 2.1.0 EXACT ${ign_package_quiet} ${ign_package_required} COMPONENTS tpe)
# --------------------------------

if(NOT TARGET ignition-physics2::ignition-physics2-tpe-plugin)
  include("${CMAKE_CURRENT_LIST_DIR}/ignition-physics2-tpe-plugin-targets.cmake")
  ...
  add_library(ignition-physics2::tpe-plugin INTERFACE IMPORTED)
  set_target_properties(ignition-physics2::tpe-plugin PROPERTIES
    INTERFACE_LINK_LIBRARIES "ignition-physics2::ignition-physics2-tpe-plugin")
...
if(NOT ign_requested_components)
  ...
  set_target_properties(ignition-physics2::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${ign_requested_components};ignition-physics2::ignition-physics2-tpe-plugin")
endif()

set(ignition-physics2-tpe-plugin_LIBRARY ignition-physics2::ignition-physics2-tpe-plugin)

# This macro is used by ignition-cmake to automatically configure the pkgconfig
# files for ignition projects.
ign_pkg_config_entry(ignition-physics2-tpe-plugin "ignition-physics2-tpe-plugin")

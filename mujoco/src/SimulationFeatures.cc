                                          ...
                                          const ForwardStep::Input &_u)
{
  ...
  //    mj_makeConstraint but never solves them, so on the step where a contact
  //    first appears, GetContactsFromLastStep would report it with a zero
  //    force. Leaving d->contact as mj_step solved it keeps every reported
  //    contact paired with the constraint force that produced it.

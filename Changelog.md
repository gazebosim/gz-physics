...
1. [bazel] Bump default bazel version to 9.1.1 and bump CI workflow version (backport #1022)
    * [Pull request #1022) (#1023](https://github.com/gazebosim/gz-physics/pull/1022) (#1023)

1. Remove hash map allocation on every update step (backport #1005)
    * [Pull request #1005) (#1013](https://github.com/gazebosim/gz-physics/pull/1005) (#1013)

1. Fix building tests when using a custom install location (backport #999)
    * [Pull request #999) (#1016](https://github.com/gazebosim/gz-physics/pull/999) (#1016)

1. Enable/Disable collisions at runtime  (#991)
    * [Pull request #991) (#995](https://github.com/gazebosim/gz-physics/pull/991) (#995)

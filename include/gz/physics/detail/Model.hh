...
#ifndef GZ_PHYSICS_DETAIL_MODEL_HH_
#define GZ_PHYSICS_DETAIL_MODEL_HH_
...
void ModelStaticState::Model<PolicyT, FeaturesT>::SetStatic(bool _static)
{
  this->template Interface<ModelStaticState>()
      ->SetModelStatic(this->identity, _static);
}

/////////////////////////////////////////////////
template <typename PolicyT, typename FeaturesT>
bool ModelStaticState::Model<PolicyT, FeaturesT>::GetStatic() const
{
  return this->template Interface<ModelStaticState>()

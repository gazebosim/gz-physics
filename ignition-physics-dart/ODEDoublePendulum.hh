...
#ifndef IGNITION_PHYSICS_ODEDOUBLEPENDULUM_HH_
#define IGNITION_PHYSICS_ODEDOUBLEPENDULUM_HH_
...
namespace ignition
{
  namespace physics
  {
    namespace ode
    {
      ...
      class ODEDoublePendulum
          : public virtual ignition::physics::DoublePendulum
      {
        public: virtual ~ODEDoublePendulum();

        public: ODEDoublePendulum();
        ...
        private: std::unique_ptr<PrivateODEDoublePendulum> dataPtr;
      };
    }
  }
}
